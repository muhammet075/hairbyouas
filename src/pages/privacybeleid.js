...
export default function Privacybeleid() {
  ...
  return (
    <>
      <Head>
          <title>Hair By Ouas - Privacybeleid</title>
      ...
      <div className="pagelayout">
        <div>
          ...
          <div>
            <section>
                <p><b>Ingangsdatum: 5 juli 2025</b></p>
                <p>Bij Hair By Ouas hechten wij veel waarde aan de bescherming van uw persoonsgegevens. Dit privacybeleid legt uit welke gegevens wij verzamelen, hoe wij deze gebruiken, en hoe wij uw privacy waarborgen.</p>
