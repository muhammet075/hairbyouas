    ...
    <div className={styles.openingstijden}>
      <div>
        ...
        <section>
          ...
          <ul>
            <li><span><Image src={geslotenIco} alt="Gesloten icoon"/>Maandag</span> <span>Gesloten</span></li>
            ...
            <li><span><Image src={openIco} alt="Open icoon"/>Donderdag</span> <span>09:30 - 18:00</span></li>
            ...
            <li><span><Image src={openIco} alt="Open icoon"/>Zondag</span> <span>12:00 - 16:00</span></li>
          </ul>
